...
Version  : 3.32.0
Release  : 10
URL      : https://download.gnome.org/sources/yelp/3.32/yelp-3.32.0.tar.xz
Source0  : https://download.gnome.org/sources/yelp/3.32/yelp-3.32.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552325741
