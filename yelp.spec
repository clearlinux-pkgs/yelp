...
Version  : 3.36.0
Release  : 18
URL      : https://download.gnome.org/sources/yelp/3.36/yelp-3.36.0.tar.xz
Source0  : https://download.gnome.org/sources/yelp/3.36/yelp-3.36.0.tar.xz
...
%prep
%setup -q -n yelp-3.36.0
cd %{_builddir}/yelp-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585777323
...
cp %{_builddir}/yelp-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/yelp/ebc45949d86ed28d87b1dd4d9d866bd4667c87ff
cp %{_builddir}/yelp-3.36.0/data/mathjax/LICENSE %{buildroot}/usr/share/package-licenses/yelp/2b8b815229aa8a61e483fb4ba0588b8b6c491890
%make_install
%find_lang yelp
