...
Source0  : https://download.gnome.org/sources/yelp/40/yelp-40.0.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619121889
...
cp %{_builddir}/yelp-40.0/COPYING %{buildroot}/usr/share/package-licenses/yelp/ebc45949d86ed28d87b1dd4d9d866bd4667c87ff
cp %{_builddir}/yelp-40.0/data/mathjax/LICENSE %{buildroot}/usr/share/package-licenses/yelp/2b8b815229aa8a61e483fb4ba0588b8b6c491890
%make_install
%find_lang yelp
