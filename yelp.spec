...
Version  : 3.32.2
Release  : 13
URL      : https://download.gnome.org/sources/yelp/3.32/yelp-3.32.2.tar.xz
Source0  : https://download.gnome.org/sources/yelp/3.32/yelp-3.32.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557327317
export AR=gcc-ar
...
cp data/mathjax/LICENSE %{buildroot}/usr/share/package-licenses/yelp/data_mathjax_LICENSE
%make_install
%find_lang yelp
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/yelp/COPYING
/usr/share/package-licenses/yelp/data_mathjax_LICENSE
