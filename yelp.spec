...
Version  : 3.38.1
Release  : 21
URL      : https://download.gnome.org/sources/yelp/3.38/yelp-3.38.1.tar.xz
Source0  : https://download.gnome.org/sources/yelp/3.38/yelp-3.38.1.tar.xz
...
%prep
%setup -q -n yelp-3.38.1
cd %{_builddir}/yelp-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601834459
...
cp %{_builddir}/yelp-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/yelp/ebc45949d86ed28d87b1dd4d9d866bd4667c87ff
cp %{_builddir}/yelp-3.38.1/data/mathjax/LICENSE %{buildroot}/usr/share/package-licenses/yelp/2b8b815229aa8a61e483fb4ba0588b8b6c491890
%make_install
%find_lang yelp
