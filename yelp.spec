...
Source0  : https://download.gnome.org/sources/yelp/41/yelp-41.2.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638607305
...
cp %{_builddir}/yelp-41.2/COPYING %{buildroot}/usr/share/package-licenses/yelp/ebc45949d86ed28d87b1dd4d9d866bd4667c87ff
cp %{_builddir}/yelp-41.2/data/mathjax/LICENSE %{buildroot}/usr/share/package-licenses/yelp/2b8b815229aa8a61e483fb4ba0588b8b6c491890
%make_install
%find_lang yelp
